...
import VideoHandler;
#else
import vlc.VideoHandler as VideoHandler;
#end
#end
using StringTools;
...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		timeTxt.setFormat(Paths.font('ATTFShinGoProDeBold.ttf'), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		topBar = new FlxSprite(0, -200).makeGraphic(FlxG.width, 100, FlxColor.BLACK);
		add(topBar);

		bottomBar = new FlxSprite(0, FlxG.height + 500).makeGraphic(FlxG.width, 200, FlxColor.BLACK);
		add(bottomBar);
		...
		scoreTxt.setFormat(Paths.font("ATTFShinGoProUltra.ttf"), 40, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		startTimer = new FlxTimer().start(Conductor.crochet / 1000 / playbackRate, function(tmr:FlxTimer)
		{
			...
			switch (swagCounter)
			{
				case 0:
					...
					FlxTween.tween(countdown3, {/*y: countdown3.y + 100,*/ alpha: 0}, Conductor.crochet / 1000, {
				...
				case 1:
					...
					FlxTween.tween(countdown2, {/*y: countdown2.y + 100,*/ alpha: 0}, Conductor.crochet / 1000, {
						ease: FlxEase.cubeInOut,
						onComplete: function(twn:FlxTween)
						{
							remove(countdown2);
				...
				case 2:
					...
					countdown1.updateHitbox();

					FlxTween.tween(topBar, {y: 0}, 0.3, {ease: FlxEase.circOut});
					FlxTween.tween(bottomBar, {y: FlxG.height - 100}, 0.3, {ease: FlxEase.circOut});

					countdown1.screenCenter();
					countdown1.antialiasing = antialias;
					insert(members.indexOf(notes), countdown1);
					FlxTween.tween(countdown1, {/*y: countdown1.y + 100,*/ alpha: 0}, Conductor.crochet / 1000, {
						ease: FlxEase.cubeInOut,
						onComplete: function(twn:FlxTween)
						{
							remove(countdown1);
				...
				case 3:
					...
					FlxTween.tween(countdownGo, {/*y: countdown2.y + 100,*/ alpha: 0}, Conductor.crochet / 1000, {
						ease: FlxEase.cubeInOut,
						onComplete: function(twn:FlxTween)
						{
							remove(countdownGo);
